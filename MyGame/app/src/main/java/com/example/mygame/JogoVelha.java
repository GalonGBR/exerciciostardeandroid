...
public class JogoVelha extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnVoltarJVelha.setOnClickListener(new View.OnClickListener() {
            @Override
    ...
    private void voltarJVelha(){
        Intent voltarJanelaJVelha = new Intent(this, MainActivity.class);
        startActivity(voltarJanelaJVelha);
    }
